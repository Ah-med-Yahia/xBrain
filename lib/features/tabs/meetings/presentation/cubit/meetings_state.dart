...
class MeetingsState extends Equatable {
  ...
  final int declineMessageLength;
  ...
  MeetingsState copyWith({
    ...
    return MeetingsState(
      ...
      declineMessageLength: declineMessageLength ?? this.declineMessageLength,
    );
  }
