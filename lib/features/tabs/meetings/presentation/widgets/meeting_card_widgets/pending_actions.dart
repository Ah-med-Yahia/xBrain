...
import 'package:explaino/features/tabs/meetings/presentation/widgets/meeting_card_widgets/slot_selection_sheet.dart';
...
class _AcceptButton extends StatelessWidget {
  ...
  Future<void> _handleAccept(BuildContext context) async {
    final selectedSlot = await showModalBottomSheet<AcceptMeetingRequestEntity>(
      backgroundColor: AppColors.white,
      context: context,
      builder: (_) => SlotsSelectionSheet(slots: meeting.proposedSlots),
    );
