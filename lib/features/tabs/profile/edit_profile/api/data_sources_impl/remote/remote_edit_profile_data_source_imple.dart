...
import 'package:explaino/features/tabs/profile/edit_profile/data/mappers/edit_profile_mapper.dart';
...
class RemoteEditProfileDataSourceImple implements RemoteEditProfileDataSource {
  ...
  Future<BaseResponse<UserModel>> editProfile(EditProfileRequestModel request) {
    return safeApiCall(
      () async =>
          _apiClient.updateProfile(await EditProfileMapper.toFormData(request)),
    );
  }
}
